...
var app = (function () {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$5, 41, 0, 1439);
    		},
    ...
    function create_key_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			if (default_slot) default_slot.c();
    			add_location(div, file$4, 133, 8, 4613);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "svelte-ljjwec");
    			add_location(button0, file$3, 10, 16, 595);
    			attr_dev(button1, "class", "svelte-ljjwec");
    			add_location(button1, file$3, 11, 16, 661);
    			add_location(nav, file$3, 9, 14, 572);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "logo-img svelte-ljjwec");
    			if (!src_url_equal(img.src, img_src_value = "https://downloader.disk.yandex.ru/preview/316983f474d11db64cba41a46d0e7186f1df1e7f5123595fa35167e1fdfc52f4/656f3584/9zHZpDC65yV6MVCZ3QpCqarClZ0lzo1vJR6jKCU2CDg4jD_lBn06jQiwKCeXBSQhuGS4c74HkWusFC0daZvfTQ%3D%3D?uid=0&filename=LOGO.png&disposition=inline&hash=&limit=0&content_type=image%2Fpng&owner_uid=0&tknv=v2&size=1920x931")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$3, 5, 10, 122);
    			attr_dev(div0, "class", "logo svelte-ljjwec");
    			add_location(div0, file$3, 4, 8, 93);
    			attr_dev(div1, "class", "button-content svelte-ljjwec");
    			add_location(div1, file$3, 7, 8, 508);
    			attr_dev(header, "class", "svelte-ljjwec");
    			add_location(header, file$3, 3, 0, 76);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			body = element("body");
    			h1 = element("h1");
    			h1.textContent = "Фотографии загородного клуба";
    			t1 = space();
    			hr = element("hr");
    			t2 = space();
    			h20 = element("h2");
    			h20.textContent = "Шале";
    			t4 = space();
    			div0 = element("div");
    			img0 = element("img");
    			t5 = space();
    			...
    			t13 = space();
    			img7 = element("img");
    			attr_dev(h1, "class", "article svelte-1e9iqzl");
    			add_location(h1, file$2, 3, 4, 43);
    			attr_dev(hr, "class", "green-line svelte-1e9iqzl");
    			add_location(hr, file$2, 4, 4, 101);
    			attr_dev(h20, "class", "svelte-1e9iqzl");
    			add_location(h20, file$2, 5, 4, 129);
    			attr_dev(img0, "class", "img svelte-1e9iqzl");
    			if (!src_url_equal(img0.src, img0_src_value = "http://hday33.ru/img/220318/220318_14.jpg")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "sfsdfd");
    			add_location(img0, file$2, 7, 6, 177);
    			attr_dev(img1, "class", "img svelte-1e9iqzl");
    			if (!src_url_equal(img1.src, img1_src_value = "http://hday33.ru/img/220617/DSC_0300%D1%87%D1%81%D1%87.jpg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "sfsdfd");
    			add_location(img1, file$2, 12, 6, 294);
    			attr_dev(img2, "class", "img svelte-1e9iqzl");
    			if (!src_url_equal(img2.src, img2_src_value = "http://hday33.ru/img/220318/220318_3.jpg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "sfsdfsdfd");
    			add_location(img2, file$2, 17, 6, 428);
    			attr_dev(img3, "class", "img svelte-1e9iqzl");
    			if (!src_url_equal(img3.src, img3_src_value = "http://hday33.ru/img/220318/220318_4.jpg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "dfsfsdfd");
    			add_location(img3, file$2, 22, 6, 547);
    			attr_dev(div0, "class", "container svelte-1e9iqzl");
    			add_location(div0, file$2, 6, 4, 147);
    			attr_dev(h21, "class", "svelte-1e9iqzl");
    			add_location(h21, file$2, 28, 4, 674);
    			attr_dev(img4, "class", "img svelte-1e9iqzl");
    			if (!src_url_equal(img4.src, img4_src_value = "http://hday33.ru/img/0U6A6110.jpg")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "sfsdfsdfd");
    			add_location(img4, file$2, 30, 8, 731);
    			attr_dev(img5, "class", "img svelte-1e9iqzl");
    			if (!src_url_equal(img5.src, img5_src_value = "http://hday33.ru/img/220318/230318_2.JPG")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "sfsdfsdfd");
    			add_location(img5, file$2, 35, 8, 853);
    			attr_dev(img6, "class", "img svelte-1e9iqzl");
    			if (!src_url_equal(img6.src, img6_src_value = "http://hday33.ru/img/0U6A6099.jpg")) attr_dev(img6, "src", img6_src_value);
    			attr_dev(img6, "alt", "dfsfsdfd");
    			add_location(img6, file$2, 40, 8, 982);
    			attr_dev(img7, "class", "img svelte-1e9iqzl");
    			if (!src_url_equal(img7.src, img7_src_value = "http://hday33.ru/img/220318/230318_1.jpg")) attr_dev(img7, "src", img7_src_value);
    			attr_dev(img7, "alt", "sfsdfd");
    			add_location(img7, file$2, 45, 8, 1103);
    			attr_dev(div1, "class", "container svelte-1e9iqzl");
    			add_location(div1, file$2, 29, 6, 699);
    			attr_dev(body, "class", "body");
    			add_location(body, file$2, 2, 0, 19);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = `${/*validateForm*/ ctx[1]().name}`;
    			attr_dev(span, "class", "svelte-1f38u27");
    			add_location(span, file$1, 54, 8, 1309);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = `${/*validateForm*/ ctx[1]().email}`;
    			attr_dev(span, "class", "svelte-1f38u27");
    			add_location(span, file$1, 63, 8, 1575);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span.textContent = `${/*validateForm*/ ctx[1]().email}`;
    			attr_dev(span, "class", "svelte-1f38u27");
    			add_location(span, file$1, 61, 8, 1493);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			span.textContent = `${/*validateForm*/ ctx[1]().password}`;
    			attr_dev(span, "class", "svelte-1f38u27");
    			add_location(span, file$1, 72, 8, 1858);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span.textContent = `${/*validateForm*/ ctx[1]().password}`;
    			attr_dev(span, "class", "svelte-1f38u27");
    			add_location(span, file$1, 70, 8, 1770);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(70:6) {#if formData.password === ''}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*formData*/ ctx[0].name === '' && create_if_block_4(ctx);

    	function select_block_type(ctx, dirty) {
    		if (/*formData*/ ctx[0].email === '') return create_if_block_2;
    		if (show_if_1 == null) show_if_1 = !!/*validateForm*/ ctx[1]().email;
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*formData*/ ctx[0].password === '') return create_if_block;
    		if (show_if == null) show_if = !!/*validateForm*/ ctx[1]().password;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 52, 6, 1219);
    			attr_dev(label0, "class", "svelte-1f38u27");
    			add_location(label0, file$1, 50, 4, 1194);
    			attr_dev(input1, "type", "email");
    			add_location(input1, file$1, 59, 6, 1400);
    			attr_dev(label1, "class", "svelte-1f38u27");
    			add_location(label1, file$1, 57, 4, 1373);
    			attr_dev(input2, "type", "password");
    			add_location(input2, file$1, 68, 6, 1668);
    			attr_dev(label2, "class", "svelte-1f38u27");
    			add_location(label2, file$1, 66, 4, 1640);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$1, 75, 4, 1926);
    			attr_dev(form, "class", "svelte-1f38u27");
    			add_location(form, file$1, 49, 2, 1143);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*formData*/ 1 && input2.value !== /*formData*/ ctx[0].password) {
    				set_input_value(input2, /*formData*/ ctx[0].password);
    			}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			create_component(router.$$.fragment);
    			attr_dev(main, "class", "svelte-vzsf7k");
    			add_location(main, file, 6, 0, 187);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Header, Router, Route, Link, Home, Login });
    	return [];
    }
